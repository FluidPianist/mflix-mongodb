...
export default class UsersDAO {
  ...
  */
  ...
  static async getUser(email) {
    ...
    //const data= await users.findOne({name:"foo"});
      //console.log(data);
    ...
    try {
      ...
      */
      ...
      const updateResponse = await users.updateOne(
        { email:email },
        { $set: {preferences} },//if bracket around preferences is not used then its field will be added to the document directly. if it is usesd then a preference field will be creted with all its values attacjed inside the preference field which would be of object type.
      )
