...
// To read more about this type of expression, refer to https://developer.mozilla.org/en-US/docs/Glossary/IIFE
    ...
    //To execute the IIFE function type "node src\migrations\movie-last-updated-migration.js" in the root folder(i.e. mflix-js) and then run the test
;(async () => {
  try {
    ...
    // over the wire!
    const predicate = {lastupdated:{$type:2,$ne:null}}
